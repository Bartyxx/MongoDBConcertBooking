<!-- ---------------------------------------------------------------------- -->
<h1 align="center">MongoDBConcertBooking</h1>
<!-- ---------------------------------------------------------------------- -->
...
<div align="center">
    <img src = "https://github.com/Bartyxx/MongoDBConcertBooking/blob/main/img/logo.jpg"/>
</div>
...
<p>It's possible to filter by:</p>
<ul>
    <li>artist</li>
    <li>date</li>
    <li>city</li>
...
<p>An example of interaction is:<br /></p>
...
<p>Example of one document for every collection in the MongoDB database:</p>
<ul>
    <li>concert</li>
